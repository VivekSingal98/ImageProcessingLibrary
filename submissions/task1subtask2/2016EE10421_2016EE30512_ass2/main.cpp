...
{     
  ...
  if(argc==9 && (check=="convolution_mult"||check=="convolution")) {
    ...
    int sizeMatrix1=stoi(argv[5]);
    string inputFile2=argv[6];
    int sizeMatrix2=stoi(argv[7]);
    ...
    if(check=="convolution_mult") {
      ...
      matrix3=matrix_convolution_with_mult(matrix1_pad,m1,n1,matrix2,m2,n2,method);
  ...
  //help if argument matches no specified format
    ...
    cout << "HELP:" << endl;
    cout << "convolution with multiplication usage:" << endl;
    cout << "% ./main convolution_mult pthread/openblas padding input_file input_rows kernel_file kernel_rows output_file" << endl;
    cout << "convolution without multiplication usage:" << endl;
    cout << "% ./main convolution convoltion padding input_file input_rows kernel_file kernel_rows output_file" << endl;
