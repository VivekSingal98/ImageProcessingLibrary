...
void errorArgumentsSampling() {
  cerr<<"Wrong arguments. Follow below pattern for sampling"<<endl;
  cerr<<"./main maxpool/avgpool input_file input_rows kernel_rows output_file"<<endl;
}
